		...
		<div
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<li><a class="nav-link scrollto" href="game.html">WebGame</a>
					</li>
				</ul>
...
<body>
	...
	<footer id="footer">
				...
				<div class="row">
					<div class="col-lg-3 col-md-6">
						<div class="footer-info">
							...
							<p>
								군산대학교 <br /> ....<br />
								<br /> <strong>Phone:</strong> +82 XXXX XXXX<br /> <strong>Email:</strong>
								hong@kunsan.ac.kr<br />
							</p>
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>DY</span></strong>. All Rights
				Reserved
			</div>
			<div class="credits">
